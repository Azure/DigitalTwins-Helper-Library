...
namespace ConnectedGridAccelerator.ManagementApi.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the UserDefinedFunctionCreate class.
        /// </summary>
        public UserDefinedFunctionCreate()
        {
            CustomInit();
        }
        ...
        public UserDefinedFunctionCreate(System.Guid spaceId, string name, string friendlyName = default(string), string description = default(string), bool? disabled = default(bool?), System.Collections.Generic.IList<System.Guid?> matchers = default(System.Collections.Generic.IList<System.Guid?>))
        {
            SpaceId = spaceId;
            Name = name;
