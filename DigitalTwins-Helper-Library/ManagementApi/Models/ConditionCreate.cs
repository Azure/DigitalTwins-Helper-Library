...
namespace ConnectedGridAccelerator.ManagementApi.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ConditionCreate class.
        /// </summary>
        ...
        public ConditionCreate(string target = default(string), string path = default(string), string value = default(string), string comparison = default(string))
        {
            Target = target;
            Path = path;
            Value = value;
