...
namespace ConnectedGridAccelerator.ManagementApi.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the MatcherUpdate class.
        /// </summary>
        public MatcherUpdate()
        {
            CustomInit();
        }
        ...
        public MatcherUpdate(string name = default(string), string description = default(string), string friendlyName = default(string), System.Collections.Generic.IList<ConditionUpdate> conditions = default(System.Collections.Generic.IList<ConditionUpdate>))
        {
            Name = name;
        ...
        public System.Collections.Generic.IList<ConditionUpdate> Conditions { get; set; }
