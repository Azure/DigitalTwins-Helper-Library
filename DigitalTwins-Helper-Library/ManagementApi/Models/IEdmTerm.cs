...
namespace ConnectedGridAccelerator.ManagementApi.Models
{
    ...
    public partial class IEdmTerm
    {
        ...
        /// Initializes a new instance of the IEdmTerm class.
        /// </summary>
        public IEdmTerm(int? termKind = default(int?), int? schemaElementKind = default(int?), string namespaceProperty = default(string), string name = default(string))
        {
            TermKind = termKind;
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "termKind")]
        public int? TermKind { get; private set; }
