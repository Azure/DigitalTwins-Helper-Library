...
namespace ConnectedGridAccelerator.ManagementApi.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the SpaceRetrieveWithProperties
        /// class.
        /// </summary>
        public SpaceRetrieveWithProperties()
        {
            CustomInit();
        }
        ...
        public SpaceRetrieveWithProperties(System.Guid id, string name, int typeId, int subtypeId, int statusId, System.Collections.Generic.IList<ExtendedPropertyRetrieve> properties = default(System.Collections.Generic.IList<ExtendedPropertyRetrieve>), string description = default(string), string friendlyName = default(string), string type = default(string), System.Guid? parentSpaceId = default(System.Guid?), string subtype = default(string), Location location = default(Location), int? timeZoneId = default(int?), string status = default(string), string fullName = default(string), System.Collections.Generic.IList<string> spacePaths = default(System.Collections.Generic.IList<string>), Location effectiveLocation = default(Location), int? effectiveTimeZoneId = default(int?))
        {
