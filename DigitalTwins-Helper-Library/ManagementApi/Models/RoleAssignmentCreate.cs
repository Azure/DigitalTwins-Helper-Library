...
namespace ConnectedGridAccelerator.ManagementApi.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the RoleAssignmentCreate class.
        /// </summary>
        ...
        public RoleAssignmentCreate(System.Guid roleId, string objectId, string objectIdType, string path, System.Guid? tenantId = default(System.Guid?))
        {
            RoleId = roleId;
            ObjectId = objectId;
        ...
        public virtual void Validate()
        {
            ...
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "ObjectIdType");
            }
            if (Path == null)
            {
