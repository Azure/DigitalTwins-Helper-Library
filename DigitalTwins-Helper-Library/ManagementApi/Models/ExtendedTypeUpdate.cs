...
namespace ConnectedGridAccelerator.ManagementApi.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ExtendedTypeUpdate class.
        /// </summary>
        public ExtendedTypeUpdate()
        {
            CustomInit();
        }
        ...
        public ExtendedTypeUpdate(System.Guid? spaceId = default(System.Guid?), string name = default(string), string friendlyName = default(string), string description = default(string), bool? disabled = default(bool?), int? logicalOrder = default(int?))
        {
            SpaceId = spaceId;
            Name = name;
